...
### 핵심 UX 원칙
**말로 "○○에게 ○○ 보내줘"는 항상 다음 단계로 진행됩니다.** 어르신을 막지 않는 게 핵심이에요. 위험 신호만 보호자(아들)에게 알려 상의합니다.

| 상황 | 동작 |
|---|---|
| 등록된 분 · 평소 금액 | ✅ 바로 토스 송금화면으로 |
| 등록된 분 · 30만원 이상 고액 | ⚠️ 큰아들에게 알려 확인 후 진행 |
| **모르는 이름**(등록 안 됨) | 🔔 막지 않고 **큰아들에게 알림 → 상의·계좌 확인** (피싱 방어) |
| 새 계좌 직접 입력(➕ 새로운 곳) | 🔔 큰아들 승인 후 목록에 추가 |
